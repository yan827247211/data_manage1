...
1d78b01d-aa04-11e9-b780-18ded7a37962:1-55780,
25b4f59a-e231-11e8-a07c-6c92bf5b8b32:1-256';

--
-- Table structure for table `dy_ad_video_composite`
--

DROP TABLE IF EXISTS `dy_ad_video_composite`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dy_ad_video_composite` (
  `ad_video_composite_id` bigint(20) unsigned NOT NULL COMMENT '广告视频综合榜ID',
  ...
  PRIMARY KEY (`ad_video_composite_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dy_audio`
--

DROP TABLE IF EXISTS `dy_audio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dy_audio` (
  `audio_id` bigint(20) unsigned NOT NULL COMMENT '音频ID',
  `heat_index` decimal(10,2) DEFAULT NULL COMMENT '热度指数',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='抖音音频榜';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dy_rpt_expert`
--

DROP TABLE IF EXISTS `dy_rpt_expert`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dy_rpt_expert` (
  `expert_id` varchar(255) NOT NULL COMMENT '达人id',
  `unique_id` varchar(255) NOT NULL COMMENT '抖音用户ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='达人统计表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dy_rpt_expert_composite_2019/8/29_停用`
--

DROP TABLE IF EXISTS `dy_rpt_expert_composite_2019/8/29_停用`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dy_rpt_expert_composite_2019/8/29_停用` (
...
--
-- Table structure for table `dy_rpt_expert_growing_2019/8/29_停用`
--

DROP TABLE IF EXISTS `dy_rpt_expert_growing_2019/8/29_停用`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dy_rpt_expert_growing_2019/8/29_停用` (
...
CREATE TABLE `dy_rpt_expert_live_broadcast` (
  ...
  `unique_id` varchar(20) NOT NULL COMMENT '抖音用户ID',
...
CREATE TABLE `dy_rpt_good_commodity` (
  ...
  `unique_id` varchar(255) DEFAULT NULL COMMENT '抖音用户ID',
  `head_portrait` varchar(255) NOT NULL COMMENT '头像',
  `nickname` varchar(255) NOT NULL COMMENT '昵称',
  `fans_number` bigint(20) unsigned NOT NULL COMMENT '粉丝数',
...
--
-- Table structure for table `dy_rpt_video`
--

DROP TABLE IF EXISTS `dy_rpt_video`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dy_rpt_video` (
  ...
  `video_soaring_ranking` int(11) unsigned NOT NULL COMMENT '视频飙升榜名次',
  `soaring_exponent` decimal(10,2) unsigned NOT NULL COMMENT '飙升指数',
  `like_number` bigint(20) unsigned NOT NULL COMMENT '点赞数',
  `like_increment` bigint(20) unsigned NOT NULL COMMENT '点赞增量',
  `like_speed_increase` decimal(10,2) NOT NULL COMMENT '点赞增速',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='视频统计表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dy_rpt_video_composite_2019/8/29_停用`
--

DROP TABLE IF EXISTS `dy_rpt_video_composite_2019/8/29_停用`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dy_rpt_video_composite_2019/8/29_停用` (
...
CREATE TABLE `dy_rpt_video_monitor` (
  ...
  `comment_increment` bigint(20) unsigned NOT NULL COMMENT '评论增量',
  `total_play_increment` bigint(20) unsigned NOT NULL COMMENT '总播放数',
  ...
  PRIMARY KEY (`video_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='抖音视频监控表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dy_rpt_video_soaring_2019/8/29_停用`
--

DROP TABLE IF EXISTS `dy_rpt_video_soaring_2019/8/29_停用`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dy_rpt_video_soaring_2019/8/29_停用` (
...
CREATE TABLE `ks_rpt_advertising_video_composite` (
  `advertising_video_id` varchar(255) NOT NULL COMMENT '广告视频id',
  ...
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`advertising_video_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ks_rpt_expert_composite` (
  ...
  `kwai_id` varchar(255) NOT NULL COMMENT '快手号id',
  `expert_composite_ranking` int(11) unsigned DEFAULT NULL COMMENT '达人综合榜名次',
  `expert_index` decimal(10,2) unsigned NOT NULL COMMENT '达人指数',
  `expert_growing_ranking` int(11) DEFAULT NULL COMMENT '达人成长榜名次',
  `growing_index` decimal(10,2) NOT NULL COMMENT '成长指数',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='达人综合榜，达人成长榜';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ks_rpt_expert_growing` (
  ...
  `video_number` int(11) unsigned NOT NULL COMMENT '视频数',
  `like_number_interval` int(11) unsigned NOT NULL COMMENT '点赞数区间（0：100-500、1：500-1000、2：1000-2000、3：2000以上）',
  `play_number_interval` int(11) unsigned NOT NULL COMMENT '评论数区间（0：5-10、1：10-50、2：50-100、3：100-200、4：200以上）',
  `fan_number` bigint(20) unsigned NOT NULL COMMENT '粉丝数',
  `fan_number_interval` int(11) unsigned NOT NULL COMMENT '粉丝数区间（0：100-500、1：500-1000、2：1000-2000、3：2000以上）',
  `fan_increment` int(11) unsigned NOT NULL COMMENT '粉丝增量',
  `fan_speed_increase` decimal(10,2) unsigned NOT NULL COMMENT '粉丝增速',
  `like_number` bigint(20) unsigned NOT NULL COMMENT '点赞数',
  `like_increment` int(11) unsigned NOT NULL COMMENT '点赞增量',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='达人成长榜（废弃）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `ks_rpt_expert_trend`
--

DROP TABLE IF EXISTS `ks_rpt_expert_trend`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `ks_rpt_expert_trend` (
  `expert_trend_id` varchar(255) NOT NULL COMMENT '达人趋势id',
  `kwai_id` varchar(255) NOT NULL COMMENT '快手号id',
  `fan_increment` int(11) unsigned NOT NULL COMMENT '粉丝增量',
  `fan_speed_increase` decimal(10,2) unsigned NOT NULL COMMENT '粉丝增速',
  `like_increment` int(11) unsigned NOT NULL COMMENT '点赞增量',
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`expert_trend_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='达人趋势详情表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ks_rpt_good_commodity` (
  ...
  `sales_volume` int(11) unsigned NOT NULL COMMENT '销量区间（0.1以下、0.1-1.0、1.0-5.0、5.0-10.0、10.0-20.0、20.0-50.0、50.0以上 ）',
  `commodity_source` varchar(255) NOT NULL COMMENT '商品来源',
  `data_update_time` int(11) unsigned NOT NULL COMMENT '数据更新时间',
  `date_type` int(11) unsigned NOT NULL COMMENT '日期类型（0:当天数据统计,1:七天数据统计,2:30天数据统计）',
  `date` varchar(255) NOT NULL COMMENT '日期',
  `status` int(11) unsigned NOT NULL COMMENT '状态',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `ks_rpt_music_audio` (
  ...
  `user_use_number_increment` int(11) unsigned NOT NULL COMMENT '使用人数增量',
  ...
  `name` varchar(255) NOT NULL COMMENT '作者昵称',
  `data_update_time` int(11) unsigned NOT NULL COMMENT '数据更新时间（秒）',
  `status` int(11) unsigned NOT NULL COMMENT '状态（0：未删除，1：已删除）',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`audio_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='音频表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ks_rpt_video_trend` (
  `video_trend_id` varchar(255) NOT NULL COMMENT '视频趋势id',
  `video_id` bigint(20) unsigned NOT NULL COMMENT '视频id',
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`video_trend_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='视频趋势表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-08-31 14:36:08
