...
(
    ...
    `audio_ranking`             int(11)                      DEFAULT NULL COMMENT '音频名次',
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='达人统计表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='视频统计表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `ks_rpt_expert`;
/*!40101 SET @saved_cs_client = @@character_set_client */;
SET character_set_client = utf8mb4;
CREATE TABLE `ks_rpt_expert`
(
    `expert_composite_id`                varchar(255)            NOT NULL COMMENT '达人综合id',
    `kwai_id`                            varchar(255)            NOT NULL COMMENT '快手号id',
    `expert_composite_ranking`           int(11) unsigned        NOT NULL COMMENT '达人综合榜名次',
    `expert_index`                       decimal(10, 2) unsigned NOT NULL COMMENT '达人指数',
    `expert_growing_ranking`             int(11) unsigned        NOT NULL COMMENT '达人成长榜名次',
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='达人成长榜（废弃）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    `video_average_play_number_interval` int(11) unsigned        NOT NULL COMMENT '视频均播数区间（0：10以下、1：10-50、2：50-100、3：100-200、4：200-500、5：500以上）',
    `expert_sex`                         int(11) unsigned        NOT NULL COMMENT '达人性别（0：男，1：女）',
    `expert_age`                         int(11) unsigned        NOT NULL COMMENT '达人年龄',
    `expert_province`                    varchar(255)            NOT NULL COMMENT '达人所在省份',
    `expert_city`                        varchar(255)            NOT NULL COMMENT '达人所在城市',
    `account_verification`               varchar(255)                     DEFAULT NULL COMMENT '账号认证',
...
--
-- Table structure for table `ks_rpt_video`
--

DROP TABLE IF EXISTS `ks_rpt_video`;
/*!40101 SET @saved_cs_client = @@character_set_client */;
SET character_set_client = utf8mb4;
CREATE TABLE `ks_rpt_video`
(
    `video_composite_id`            varchar(255)            NOT NULL COMMENT '视频综合id',
    `composite_ranking`             int(11) unsigned        NOT NULL COMMENT '综合榜名次',
    `soaring_ranking`               int(11) unsigned        NOT NULL COMMENT '飙升榜名次',
    `video_id`                      bigint(20) unsigned     NOT NULL COMMENT '视频id',
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='视频飙升榜（废弃）';
/*!40101 SET character_set_client = @saved_cs_client */;
