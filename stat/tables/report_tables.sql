...
(
    ...
    `ad_video_id`     bigint(20) unsigned                NOT NULL COMMENT '广告视频ID',
    `ad_video_cover`  varchar(255)                       NOT NULL COMMENT '广告视频封面',
    `ad_video_title`  varchar(255)                       NOT NULL COMMENT '广告视频标题',
    `ad_side_name`    varchar(255)                       NOT NULL COMMENT '广告方名称',
    `ad_video_time`   bigint(20) unsigned                NOT NULL COMMENT '广告时长',
    ...
    `comments_number` bigint(20) unsigned                NOT NULL COMMENT '评论数',
...
--
-- Table structure for table `dy_rpt_expert_2019-09-11|停用`
--

DROP TABLE IF EXISTS `dy_rpt_expert_2019-09-11|停用`;
/*!40101 SET @saved_cs_client = @@character_set_client */;
SET character_set_client = utf8mb4;
CREATE TABLE `dy_rpt_expert_2019-09-11|停用`
(
...
(
    ...
    `user_id`             bigint(20)                         NOT NULL COMMENT '抖音用户id',
    `unique_id`           varchar(255) CHARACTER SET utf8mb4 NOT NULL COMMENT '抖音号',
    ...
    `age_proportion`      varchar(255)                       NOT NULL COMMENT '各年龄段所占比例(不同年龄段所占比例由 , 分隔开)\r\n 各年龄段（6-17、18-24、25-30、31-35、36-40、41+）',
    `female_fans_ratio`   decimal(10, 2)                     NOT NULL COMMENT '女性粉丝所占比例',
...
(
    ...
    `user_id`                  bigint(20)                                  DEFAULT NULL COMMENT '抖音用户id',
...
--
-- Table structure for table `dy_rpt_video_2019-09-11|停用`
--

DROP TABLE IF EXISTS `dy_rpt_video_2019-09-11|停用`;
/*!40101 SET @saved_cs_client = @@character_set_client */;
SET character_set_client = utf8mb4;
CREATE TABLE `dy_rpt_video_2019-09-11|停用`
(
    `id`                           varchar(255)            NOT NULL COMMENT 'uid_日期_榜单类型',
...
(
    ...
    `video_label`                  varchar(255)                       NOT NULL COMMENT '视频标签(可以有多个标签,不同的标签由","隔开)',
    `video_hot_word`               varchar(255) CHARACTER SET utf8mb4 NOT NULL COMMENT '视频热词(可以有多个热词,不同的热词由","隔开)',
    `unique_id`                    varchar(255)                       NOT NULL COMMENT '抖音号',
    `head_portrait`                varchar(255)                       NOT NULL COMMENT '头像',
    `nickname`                     varchar(255) CHARACTER SET utf8mb4 NOT NULL COMMENT '昵称',
    `like_number_interregional`    int(11) unsigned                   NOT NULL COMMENT '点赞数区间（1：10以下、2：10-50、3：50-100、4：100-200、5：200以上） 单位：万',
...
(
    ...
    `name`                    varchar(255) CHARACTER SET utf8mb4 NOT NULL COMMENT '作者昵称',
...
(
    ...
    `name`                               varchar(255) CHARACTER SET utf8mb4 NOT NULL COMMENT '昵称',
    `industry`                           varchar(255)                       NOT NULL COMMENT '行业',
...
(
    ...
    `off_site_audience_peak_value`       int(11) unsigned                   NOT NULL COMMENT '场均观众峰值',
    `bring_goods_live_broadcast_session` int(11) unsigned                   NOT NULL COMMENT '带货直播场次',
    `date_type`                          int(11) unsigned                   NOT NULL COMMENT '日期状态（0：当天，1：七天，2：三十天）',
    `date`                               varchar(255)                       NOT NULL COMMENT '日期',
    `status`                             tinyint(3) unsigned                NOT NULL DEFAULT '0' COMMENT '状态',
    `create_time`                        datetime                           NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `update_time`                        datetime                                    DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
...
(
    ...
    `grand_total_get_list_day_number` int(11) unsigned    NOT NULL COMMENT '累计上榜天数',
...
(
    ...
    `share_userid`                  varchar(255)                       NOT NULL COMMENT '视频播放地址（组合地址）',
    `share_photoid`                 varchar(255)                       NOT NULL COMMENT '视频播放地址（组合地址）',
