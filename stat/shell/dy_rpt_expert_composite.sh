  ...
  hqlStr="
    ...
    from (
      ...
      from (
        ...
        , total_favorited, follower_count, aweme_count, video_comment_count, video_share_count, ranking, score
        from (
          select user_id, sec_user_id, unique_id, nickname, head_img, gender, age, province, city
          ...
          , row_number() over (order by follower_count+total_favorited/10000 desc) as ranking
          , follower_count+total_favorited/10000 as score
